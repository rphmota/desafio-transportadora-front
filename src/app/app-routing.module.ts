...
const routes: Routes = [
  ...
  { path: '', component: NavComponent,children: [{ path: 'home', component: HomeComponent },{ path: 'motoristas', component: MotoristasComponent },{ path: 'cargas', component: CargasComponent },{ path: 'caminhoes', component: CaminhoesComponent },{ path: 'entregas', component: EntregasComponent }] },
